...
You can find the frontend repository at [hello-react-front-end](https://github.com/Patfarmurs/hello-react-front-end).
...
```sh
  git clone https://github.com/Salwa99/hello-rails-back-end.git
```
